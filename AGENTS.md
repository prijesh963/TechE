...
6. Generates the changes, offers a real diff of each against what is on disk,
   and applies them on a click — nothing reaches the working tree unseen.
...
Use Vitest. All 380 tests must pass before merging.
